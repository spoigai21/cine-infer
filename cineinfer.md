...
**Status:** Phases 0–8 done (through Airflow): models evaluated once on test, predictions #1–#4 and #6 settled, a worse model refused by the publish gate. Phases 9–11 not started.
