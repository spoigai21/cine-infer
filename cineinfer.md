...
**Status:** Phases 0–9 done: models evaluated once on test, a worse model refused by the publish gate, predictions #1–#6 settled (Phase 9 benchmark). Phases 10–11 (write-up, demo) not started.
