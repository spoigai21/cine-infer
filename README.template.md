...
deliberately worse {{airflow.epochs}}-epoch model (validation NDCG@10 {{airflow.candidate}} vs live
{{airflow.live}}) was rejected, and the publish step was skipped (`results/airflow_reject_demo.txt`).
